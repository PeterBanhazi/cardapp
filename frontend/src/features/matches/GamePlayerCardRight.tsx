...
const GamePlayerCardRight: React.FC<PlayerCardProps> = ({ player }) => {
                    ...
                    <div className="col-start-1 row-start-1 z-10 ">
                        <div className=" p-1 m-2 ">
                            ...
                            <div className="grid grid-cols-1 pt-2 gap-2 ">
                                <button
                                    id="Favorite"
                                    className=" bg-blue-600 bg-opacity-90 w-[85px] justify-self-end text-white px-3 py-1  rounded-md text-sm font-medium hover:bg-blue-700 transition-colors"
                                ...
                                <button
                                    id="Change"
                                    className="bg-blue-600 bg-opacity-90 w-[60px] justify-self-end text-white px-3 py-1  rounded-md text-sm font-medium hover:bg-blue-700 transition-colors"
                                    onClick={handleFavoriteClick}
                                >
                                    Edit
                                </button>
...
export default GamePlayerCardRight;
