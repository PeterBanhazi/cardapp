                    ...
                    >
                        {error && (
                            <p className="text-sm text-red-700 pl-1">
                                ...
                                contain uppercase letters. Email must be unique.
                                Please try again.
                            </p>
                        )}
                    </div>
                    ...
                    >
                        ...
                        <div className="mb-3">
                            ...
                            <TextInput
                                ...
                                onChange={(e) =>
                                    form.handleUsernameChange(e.target.value)
                                }
                        ...
                        <div className="mb-3">
                            ...
                            <TextInput
                                ...
                                onChange={(e) =>
                                    form.handlePasswordChange(e.target.value)
                                }
                        ...
                        <div className="mb-3">
                            ...
                            <TextInput
                                ...
                                onChange={(e) =>
                                    form.handlePassword2Change(e.target.value)
                                }
